			...
			<div id="main">
                ...
                <section id="Play" class="one dark cover">
                    <div class="container">
                        ...
                        <?php
                            echo '<form method="post" action="updatepost.php?number='.$number.'">';
                        ?>
                            <div class="row">
                                <div class="6u 12u$(mobile)"><input type="text" name="newtitle" placeholder="새로운 제목을 입력하세요." /></div>
                                <div class="12u$">
                                    <textarea name="message" placeholder="새로운 게시글을 입력하세요."></textarea>
                                </div>
                                <div class="12u$">
